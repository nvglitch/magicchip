...
const copy = {
  en: { eyebrow: 'SITE SEARCH', title: 'Search MagicChip', subtitle: 'Search by model or requirements: wide voltage, Intel, DDR5, or Intel 9-36V.', resultsFor: 'Results for', found: 'results', empty: 'No matching results found.', emptyHint: 'Try a model or specific parameter, such as 9-36V, Intel, or DDR5. Combined terms must all match.', prompt: 'Enter a keyword to search the website.', types: { product: 'Product', category: 'Category', scenario: 'Scenario', page: 'Page', resource: 'Resource' } },
  fr: { eyebrow: 'RECHERCHE DU SITE', title: 'Rechercher sur MagicChip', subtitle: 'Recherchez un modèle ou des caractéristiques : large plage de tension, Intel, DDR5 ou Intel 9-36V.', resultsFor: 'Résultats pour', found: 'résultats', empty: 'Aucun résultat correspondant.', emptyHint: 'Essayez un modèle ou un paramètre, comme 9-36V ou Intel. Tous les critères doivent correspondre.', prompt: 'Saisissez un mot-clé pour rechercher sur le site.', types: { product: 'Produit', category: 'Catégorie', scenario: 'Scénario', page: 'Page', resource: 'Ressource' } },
  ...
  it: { eyebrow: 'RICERCA NEL SITO', title: 'Cerca in MagicChip', subtitle: 'Cerca per modello o caratteristiche: ampio intervallo di tensione, Intel, DDR5 o Intel 9-36V.', resultsFor: 'Risultati per', found: 'risultati', empty: 'Nessun risultato corrispondente.', emptyHint: 'Prova un modello o un parametro, come 9-36V o Intel. Tutti i criteri devono corrispondere.', prompt: 'Inserisci una parola chiave per cercare nel sito.', types: { product: 'Prodotto', category: 'Categoria', scenario: 'Scenario', page: 'Pagina', resource: 'Risorsa' } },
  es: { eyebrow: 'BÚSQUEDA DEL SITIO', title: 'Buscar en MagicChip', subtitle: 'Busque por modelo o características: amplio rango de tensión, Intel, DDR5 o Intel 9-36V.', resultsFor: 'Resultados para', found: 'resultados', empty: 'No se encontraron resultados.', emptyHint: 'Pruebe un modelo o parámetro, como 9-36V o Intel. Todos los criterios deben coincidir.', prompt: 'Introduzca una palabra clave para buscar en el sitio.', types: { product: 'Producto', category: 'Categoría', scenario: 'Escenario', page: 'Página', resource: 'Recurso' } },
};
