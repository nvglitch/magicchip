...
export const fr: TranslationSchema = {
  ...
  navDropdown: {
    ...
    about: {
      ...
      contactUsDesc: 'Prenez contact avec notre équipe',
    },
    documents: {
      news: 'Actualités',
  ...
  products: {
    ...
    ctaDescription: 'Nous proposons des solutions sur mesure adaptées à vos besoins spécifiques.',
    ctaButton: 'Contacter les Ventes',
    viewOnAlibaba: 'Voir sur Alibaba',
  },
  productDetail: {
    ...
    industrialConfigDetails: 'Détails de configuration de qualité industrielle',
    specificationMatrix: 'Matrice de Spécifications {name}',
    brochureParameters: 'Paramètres matériels issus de la brochure',
    operatingRange: 'Plage de Fonctionnement',
    ...
    viewOnAlibaba: 'Voir sur Alibaba',
    closeEnlargedImage: 'Fermer l\'image agrandie',
    enlargedProductView: 'Vue agrandie du produit',
  },
  featured: {
    badge: 'Produit Phare',
    title: 'MCAIPC2',
  ...
  news: {
    ...
    placeholderContent: 'Ceci est un contenu de substitution pour l\'article complet. L\'article complet sera bientôt disponible avec des informations détaillées, des spécifications techniques et les perspectives de notre équipe.',
  },
  contactPage: {
    invalidEmail: 'Email invalide',
  },
  techDocs: {
    heroTitle: 'Documentation Technique',
    heroSubtitle: 'Ressources techniques complètes pour les développeurs et ingénieurs',
