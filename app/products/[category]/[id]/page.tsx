...
const products: Record<string, ProductDetail> = {
  ...
  mcsrp6: {
    ...
    specs: [
      ...
      { label: 'USB', value: '3 x USB 3.0 and 1 x USB 2.0' },
      { label: 'Network', value: '2 x Intel i226-V 2.5GbE LAN' },
      ...
      { label: 'TDP', value: 'Depends on the selected processor' },
  ...
  mcai1: {
    ...
    specs: [
      ...
      { label: 'Front I/O', value: '1 x USB4; 2 x USB 3.0 (10Gbps); 1 x SD card reader; 1 x combo audio jack; 1 x power button; 1 x Clear CMOS; 1 x CPU power selector (High / Medium / Low)' },
      { label: 'Rear I/O', value: '1 x HDMI 2.1; 1 x DisplayPort 2.1; 1 x USB4 with PD 3.1 28V; 4 x USB 3.0; 1 x 2.5GbE RJ45; 1 x 10GbE RJ45; 1 x audio jack' },
      { label: 'Internal I/O', value: '2 x fan headers (CPU and system); 1 x stereo speaker header (2W x 2); 1 x 5V ARGB header; 1 x fingerprint-module header; 1 x 8-pin ATX power input' },
      { label: 'BIOS', value: 'AMI BIOS in SPI flash ROM' },
      { label: 'Feature', value: 'Supports S0/S4/S5 power states (S3 not supported), USB wake, PXE, RTC power-on, Wake-on-LAN, and scheduled power-on' },
      { label: 'System', value: 'Windows 10 / Windows 11 / Linux' },
